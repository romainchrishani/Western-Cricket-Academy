          ...
          <FadeInAnimation>
            <div className="flex flex-col lg:flex-row-reverse justify-center items-center gap-10">
              ...
              <div className="text-center lg:text-left">
                <Reavel>
                  <p className="dark:text-white text-gray-800 text-lg mb-4">
                ...
                <Reavel>
                  <p className="dark:text-white text-gray-800 text-lg font-semibold mb-2">
                    Our academy offers:
                  </p>
                  <ul className="dark:text-white text-gray-800 list-disc pl-5 space-y-2">
